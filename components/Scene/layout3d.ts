...
import type { ObjectId, SimObject } from "@/lib/types";
...
export const BAG_STACK_ORDER: readonly ObjectId[] = ["marker", "tape_holder", "sponge"];

/** A small xy nudge per item so all three stay readable through the frosted wall. */
